...
public class Lambda3 {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Suppliers " + personSupplier.get().firstName);// new
																			// Person

		Supplier<Person> personSupplier1 = Person::new;
		System.out.println("Suppliers " + personSupplier1.get().firstName);// new
																			// Person

		Supplier<Person> personSupplier2 = Lambda3::getPerson;
		System.out.println("Suppliers " + personSupplier2.get().firstName);// new
																			// Person
